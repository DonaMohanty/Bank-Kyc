...
<%
	...
	<div class="sidenav">
		...
		<strong>CUSTOMER ID</strong> <b>100001</b> <strong>KYC STATUS</strong>
		<b>yellow</b>
	</div>
	<div class="main">
		 <form action="updatekyc" method="post">
			<div class="container">
				<hr>
				<input type="number" name="customerid"  size="15" required ></input><br><br>
				<label>  Country: </label>
   ...
   <option value="Zimbabwe">Zimbabwe</option>
                ...
                <option value="Aadhar Card">AadharCard</option>
				...
				<br> <label><b>Salary</b></label>
				 <input type="number" placeholder="Enter Salary" name="salary" required /> <br>
